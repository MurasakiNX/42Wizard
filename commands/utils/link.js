    ...
    run: async (client, interaction) => {
        ...
        switch (subcommand) {
            ...
            case 'setup': {
                ...
                if (!await client.sendMail(`${selectedLogin}@student.42.fr`, 'Link to a Discord account confirmation mail', `If you do not recognize this mail, please ignore it. You can verify the link between your Discord account and your 42 account by following this link <a href="https://42Wizard.fr/confirm/${syncKey}" target="_blank" style="text-decoration: none; color:#00babc;">https://42Wizard.fr/confirm/${syncKey}</a> (This link will expire after 5 minutes)`)) {
